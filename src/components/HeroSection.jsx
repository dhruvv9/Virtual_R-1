...
import video2 from '../assets_v/video2.mp4';
import video1 from '../assets_v/video1.mp4';
    ...
    return (
        <div className='flex flex-col items-center mt-6 lg:mt-20'>
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
                VitualR build tools <span className='bg-gradient-to-r from-orange-500 to-red-800
